...
Example 2:
Input: nums = [0,1,2,2,3,0,4,2], val = 2 Output: 5, nums = [0,1,4,0,3,_,_,_]Explanation: Your function should return k = 5, with the first five elements of nums containing 0, 0, 1, 3, and 4.
...
function removeAllOccurenceOfANumberFromArray(arr, val) {
  let x = 0;
...
console.log(removeAllOccurenceOfANumberFromArray(arr1, val1));
console.log(removeAllOccurenceOfANumberFromArray(arr2, val2));
